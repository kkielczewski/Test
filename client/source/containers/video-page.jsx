...
class VideoPage extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.setState({ allProducts: products, allVideos: allObject.videos, id: object.id, image: object.snippet.thumbnails.maxres.url, title: object.snippet.title });
  }
          ...
          <div className='main' >
            ...
            <div className='title' >
              ...
              <div className='buttons' >
                ...
                <Button onClick={this.likeVideo} >Lubię to</Button>
              </div>
            </div>
          ...
          <div className='sidePanel' >
            <div className='center' >
              ...
              <div className='social' >
                <Button onClick={this.shareFacebook} className='' circular color='facebook' icon='facebook' />
                <Button onClick={this.shareTwitter} className='' circular color='twitter' icon='twitter' />
                <Button className='' circular color='instagram' icon='instagram' />
              </div>
            </div>
          </div>
        </div>
